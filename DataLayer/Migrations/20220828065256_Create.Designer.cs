...
namespace DataLayer.Migrations
{
    ...
    [Migration("20220828065256_Create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Models.Hotel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DataLayer.Models.Rank", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DataLayer.Models.RoomReserved", b =>
                {
                    b.Property<string>("ReservationId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DataLayer.Models.Voucher", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DataLayer.Models.Guest", b =>
                {
                    ...
                    b.HasOne("DataLayer.Models.Rank", "Rank")
                        .WithMany("Guests")
            ...
            modelBuilder.Entity("DataLayer.Models.Invoice", b =>
                {
                    b.HasOne("DataLayer.Models.Reservation", "Reservation")
                        .WithOne("Invoice")
                        .HasForeignKey("DataLayer.Models.Invoice", "ReservationId");
                });
            ...
            modelBuilder.Entity("DataLayer.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("DataLayer.Models.Voucher", "Voucher")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("DataLayer.Models.Room", b =>
                {
                    b.HasOne("DataLayer.Models.Hotel", "Hotel")
                        .WithMany("Rooms")
                        .HasForeignKey("HotelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DataLayer.Models.RoomType", "RoomType")
                        .WithMany("Rooms")
