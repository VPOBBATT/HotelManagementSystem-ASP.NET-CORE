        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityCardId = table.Column<string>(maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomReserveds", x => new { x.ReservationId, x.RoomId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_VoucherId",
                table: "Reservations",
                column: "VoucherId");
