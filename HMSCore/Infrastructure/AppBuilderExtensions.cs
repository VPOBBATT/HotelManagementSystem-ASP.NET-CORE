...
namespace HMSCore.Infrastructure
{
    public static class AppBuilderExtensions
    {
        ...
        public static void SeedGuests(HotelManagementDbContext db)
        {
            ...
            var guests = new[]
            {
                new Guest { FirstName = "vijji", LastName = "Hristov", Address = "Lomsko shose", City = db.Cities.OrderBy(c => c.Name).FirstOrDefault(c => c.Name == "Sofia"),
